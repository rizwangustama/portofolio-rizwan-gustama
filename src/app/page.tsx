  ...
  return (
    <>
      ...
      <header className="absolute top-[50px] w-full flex justify-center">
        <menu className="text-[30px] px-[30px] md:px-[50px] py-5 md:py-6 bg-gradient-to-r from-bgLinearPrimary to-bgLinearSecondary border-2 border-opacity-[16%] rounded-xl border-ColorLinePrimary">
          <ul className="flex">
            <li className="text-[14px] md:text-[16px] px-3 md:px-4">About</li>
            <li className="text-[14px] md:text-[16px] px-3 md:px-4">Project</li>
            <li className="text-[14px] md:text-[16px] px-3 md:px-4">Testimonials</li>
            <li className="text-[14px] md:text-[16px] px-3 md:px-4">Contact</li>
          </ul>
        </menu>
      </header>
      <main>
            ...
            <div className="mb-[52px]">
              ...
              <div className="pt-[25px] pb-[27px]">
                <div className="overflow-hidden pb-2.5">
                  <h1 className="text-5xl md:text-7xl font-bold text-center" ref={boxRef1}>Transforming Concepts into</h1>
                </div>
                <div className="overflow-hidden">
                  <h1 className="text-5xl md:text-7xl font-bold text-center" ref={boxRef2}>Seamless <span className="text-ColorPrimary">User Experiences</span></h1>
                </div>
              </div>

              <div className="overflow-hidden">
                <h3 className="text-[16px] md:text-2xl text-center font-thin" ref={boxRef3}>Hi! I’m Rizwan Gustama, a Frontend Engineer based in Indonesia</h3>
              </div>
        ...
        <section className="">
          <div className="container">
            <div className="flex flex-col md:flex-row gap-8">
              <div className="w-full md:w-7/12 relative border-2 border-ColorLinePrimary border-opacity-[16%] rounded-3xl overflow-hidden">
                <Image src={ImagesNewsLeft} alt="news-left" />
                <div className="absolute bottom-0 left-0 px-[28px] md:px-10 py-[28px] md:py-16">
                  <h3 className="text-[20px] md:text-[32px] z-10 w-[367px] font-bold leading-tight">
                    I prioritize client collaboration, fostering open communication
                  </h3>
                </div>
              </div>
              <div className="w-full md:w-6/12 flex flex-col gap-8">
                <div className="h-fit w-full md:h-1/2 relative border-2 border-ColorLinePrimary border-opacity-[16%] rounded-3xl">
                  {/* <Image src={ImageBoxMaps} alt="box-maps" /> */}
                  <div className="md:absolute top-0 left-0 px-10 py-9">
                    <h3 className="text-[32px] z-10 font-bold leading-tight">I’m very flexible with time zone communications</h3>
                  </div>
                </div>
                <div className="h-fit w-full md:h-1/2 flex items-center border-2 border-ColorLinePrimary border-opacity-[16%] rounded-3xl">
                  <div className="px-10 px-10 py-9">
        ...
        <section className="py-[100px]">
          <div className="container">
            <h2 className="text-[36px] md:text-5xl text-white font-bold text-center mb-12 leading-none">A small selection of <span className="text-[#CBACF9]">recent projects</span></h2>
                ...
                <div key={index} className="border border-[#363749] border-opacity-[48%] px-6 py-9 rounded-[23px] flex flex-col gap-9 backgroundGradient">
                  ...
                  <div>
                    <div className="flex flex-col mb-[24px]">
                      <h3 className="text-white font-bold text-[20px] md:text-[32px] mb-[18px]">{project.title}</h3>
                      <p className="text-[#BEC1DD] text-[14px] md:text-[20px]">{project.desctription}</p>
                    </div>
                    <div className="flex flex-row justify-between">
                      <div className="flex relative">
                        {project.icon.map((icon, index) => (
                          <div className="w-[48px] md:w-[50px] h-[48px] md:h-[50px] border border-[#66699C] border-opacity-[43%]  rounded-full flex relative z-0 justify-center items-center backgroundIcon" style={{ left: `${index === 0 ? 0 : index * 10 * -1}px`, zIndex: `${index}` }}>
                            <Image src={icon} alt="icon" />
                          </div>
                        ))}
                      </div>
                      <a href="#" className="text-[#CBACF9] font-medium text-[16px] md:text-[20px] flex items-center gap-2.5">
                        Check Live Site
                        <svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="max-w-[2400px] mx-auto">
            ...
            <div className="container mt-[70px]">
              <div className="flex flex-wrap flex-row justify-around">
                <div>
                  <svg className={'h-[27px] md:h-[38px]'} width="197" height="38" viewBox="0 0 197 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  <svg className={'h-[27px] md:h-[38px]'} width="212" height="40" viewBox="0 0 212 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  <svg className={'h-[27px] md:h-[38px]'} width="174" height="36" viewBox="0 0 174 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  <svg className={'h-[27px] md:h-[38px]'} width="199" height="38" viewBox="0 0 199 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  <svg className={'h-[27px] w-fit md:h-[38px]'} width="174" height="40" viewBox="0 0 174 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <section className="py-[70px]">
          <div className="container">
            <h2 className="text-[38px] md:text-5xl font-bold text-white text-center mb-10 md:mb-[70px]">My <span className="text-[#CBACF9]">work experince</span></h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-[20px] gap-x-[40px] md:gap-y-[30px]">
              {experience.map((x, index) => (
                <div className="flex flex-col md:flex-row items-center gap-[20px] md:gap-[30px] border border-[#363749] py-[35px] md:py-[46px] px-5 md:px-[55px] rounded-[23px] relative overflow-hidden backgroundCardWork">
                  <span className="h-[5px] bg-[#161935] w-full absolute top-0 left-0"></span>
                  <Image src={x.link} alt={x.title} />
                  <div className="flex flex-col gap-[5px] md:gap-3">
                    <h4 className="text-white text-[20px] md:text-[28px] font-bold">{x.title}</h4>
                    <p className="text-[#BEC1DD] text-[14px] md:text-[16px]">{x.description}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="py-[60px]">
          <div className="container">
            <h3 className="text-[38px] md:text-5xl font-bold text-white text-center mb-[60px]">My <span className="text-ColorPrimary">approach</span></h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-[40px] gap-y-[30px] h-[680px]">
              {approch.map((x, index) => (
